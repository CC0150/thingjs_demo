...
declare namespace THING {
   ...
   */
  const CameraProjectionType: CameraProjectionTypeT;

  /**
   * 摄像机视角方式 <static, constant>
   */
  const CameraView: CameraViewT;

  /**
   * 内核事件 Tag 名称 <static, constant>
   */
  const EventTag: EventTagT;

  /**
   * 内核事件 <static, constant>
   */
  const EventType: EventTypeT;

  /**
   * 按键键值 <static, constant>
   */
  const KeyType: KeyTypeT;

  /**
   * 循环类型 <static, constant>
   */
  const LoopType: LoopTypeT;

  /** 数学库 */
  const Math: THING.Mathics;

  /** 地球库 */
  const EARTH: THING.EARTH;
  ...
  interface AppProp {
     ...
     * ```
     */
    off(eventType: EventTypeName, condition: EventCondition | null | undefined, callback: Function | string): void;
     ...
     * @override
     */
    on<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, callback: EventCallBackType<K>): void;
     ...
     * @override
     */
    on<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, callback: EventCallBackType<K>, tag: EventTagType, priority?: number): void;
     ...
     * @override
     */
    on<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, condition: EventCondition, callback: EventCallBackType<K>): void;
     ...
     * @override
     */
    on<K extends keyof EventTypeMapping, T = any>(eventType: K | EventTypeT, userData: T, callback: EventCallBackType<K>): void;
     ...
     * @override
     */
    on<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, condition: EventCondition, callback: EventCallBackType<K>, tag: EventTagType): void;
     ...
     * ```
     */
    on<K extends keyof EventTypeMapping, T = any>(eventType: K | EventTypeT, condition?: EventCondition, callback?: EventCallBackType<K>, tag?: EventTagType, priority?: number): void;
     ...
     * @param condition 物体类型选择条件，用于筛选子物体
     */
    one<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, callback: EventCallBackType<K>): void;
    /**
     * 绑定事件(只触发一次)
     * @param eventType 事件类型名称
     * @param condition 物体类型选择条件，用于筛选子物体
     * @param callback 事件触发的回调函数
     */
    one<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, condition: string, callback: EventCallBackType<K>): void;
    /**
     * 绑定事件(只触发一次)
     * @param eventType 事件类型名称
     * @param condition 物体类型选择条件，用于筛选子物体
     ...
     * @param callback 事件触发的回调函数
     */
    one<K extends keyof EventTypeMapping, T = any>(eventType: K | EventTypeT, condition: string, userData: T, callback: EventCallBackType<K>): void;
    /**
     * 绑定事件(只触发一次)
     * @param eventType 事件类型名称
     * @param condition 物体类型选择条件，用于筛选子物体
     ...
     * ```
     */
    one<K extends keyof EventTypeMapping, T = any>(eventType: K | EventTypeT, condition?: EventCondition, userData?: T, callback?: EventCallBackType<K>, tag?: EventTagType, priority?: number): void;
     ...
     * ```
     */
    pauseEvent<K extends keyof EventTypeMapping>(eventType: K | EventTypeName, condition?: EventCondition, tag?: EventTagType): void;
  }
  ...
  interface AppConstructor {
    ...
    new (options?: {
      ...
      /** 天空盒资源名称 */
      skyBox?: string | THING.SkyBoxT | object | Array<string>;
      /** 初始化完成的函数回调 */
  ...
  interface App extends THING.AppProp {
    ...
    selection: {
      app: THING.App;
      objects: {
        [key: number]: BaseObject | undefined;
        // 还有其他属性...
      };
      previousObjects: {
        [key: number]: BaseObject | undefined;
     ...
     * ```
     */
    captureScreenshotToImage(width?: number, height?: number, extension?: string, quality?: number): string;
     ...
     * ```
     */
    create<K extends keyof OptionMapping>(param: CreateOption<K>): OptionMapping[K]['Result'];
     ...
     */
    isKeyPressed(key: number | THING.KeyTypeT): boolean;
     ...
     * @param tag 事件标签
     */
    pauseEventInFrame<K extends keyof EventTypeMapping>(eventType: K | EventTypeName, condition: EventCondition, tag?: EventTagType): void;
     ...
     * ```
     */
    resumeEvent<K extends keyof EventTypeMapping>(eventType: K | EventTypeName, condition: EventCondition, tag?: EventTagType): void;
     ...
     * ```
     */
    trigger<K extends keyof EventTypeMapping>(eventType: K | EventTypeName, condition?: EventCondition, ev?: any): void;
  }

  /** 园区效果模板控制器，可用于替换园区的模板效果 */
  ...
  interface BaseObject extends THING.AppProp {
     ...
     * ```
     */
    getEvents(eventType: string | THING.EventTypeT): Array<any>;
     ...
     * ```
     */
    query<T extends BaseObject>(param: string | RegExp, recursive?: boolean): THING.Selector<T>;
    ...
    rotateAround(params: {
      ...
      speed?: number;
      /** 循环类型 */
      loopType?: string | THING.LoopTypeT;
     ...
     * ```
     */
    trigger<K extends keyof EventTypeMapping>(eventType: K | EventTypeName, ev?: any, tag?: EventTagType): void;
  ...
  const Building: BuildingConstructor;
   ...
   */
  interface Building extends THING.BaseObject {
    type: 'Building';
    /**
     * 获取楼层是否已经展开
     * @example
  ...
  class CameraController {
     ...
     * ```
     */
    projectionType: THING.CameraProjectionTypeT;
  ...
  const Campus: CampusConstructor;

  interface CampusConstructor {
    new (): Campus;
  }
   ...
   */
  interface Campus extends THING.BaseObject {
    type: 'Campus';
    /**
     * 获取该园区建筑对象集合
     * @example
  ...
  class EventTrigger extends BaseStyle {
     ...
     */
    addEventListener(type: string, object?: THING.BaseObject, condition?: string, callback?: Function, tag?: string, priority?: number, once?: boolean, userData?: object): void;
     ...
     * @param tag The event tag.
     */
    dispatchEvent(type: string, object?: THING.BaseObject, ev?: object, tag?: string): any;
     ...
     * @param tag The event tag.
     */
    getEventListener(type: string, object?: THING.BaseObject, condition?: string, tag?: string): any;
     ...
     * @param tag  The event tag.
     */
    removeEventListener(type: string, object?: THING.BaseObject, tag?: string): void;
  ...
  const Floor: FloorConstructor;

  interface FloorConstructor {
    new (): Floor;
  }
   ...
   */
  interface Floor extends THING.BaseObject {
    type: 'Floor';
    /**
     * 获取楼层所在的建筑对象
     * @example
  ...
  const Heatmap: HeatmapConstructor;

  interface HeatmapConstructor {
    new (param: any): Heatmap;
  }
   ...
   * ```
   */
  interface Heatmap extends THING.BaseObject {
    type: 'Heatmap';
    /**
...
heatMap.setGradient({ 0.4: 'blue', 0.6: 'cyan', 0.7: 'lime', 0.8: 'yellow', 1.0: 'red' })
   ...
   */
  interface Line extends THING.LineBase {
    type: 'Line';
    /**
     * 显示/隐藏线段
   ...
   * ```
   */
  interface Marker extends THING.BaseObject {
    type: 'Marker';
    /**
     * 设置/获取 canvas画布
     * @example
  ...
  class Mathics {
     ...
     * @example
     * ```
     * THING.Math.addVector([1,2,3],[3,4,5]); // 返回值 [-2,-2,-2]
     * ```
     */
    subVector(v1: Array<number>, v2: Array<number>): Array<number>;
     ...
     * @example
     * ```
     * THING.Math.Math.abs(x); // 返回值: Number	x 的绝对值。如果 x 不是数字返回 NaN,如果 x 为 null 返回 0。
     * ```
     */
    abs(x: number): number;
     ...
     * @param epsilon 误差范围
     */
    equalsVector(v1: Array<number>, v2: Array<number>, epsilon: number): boolean;
     ...
     * @param epsilon 误差范围
     */
    equalsVectorX(v1: Array<number>, v2: Array<number>, epsilon: number): boolean;
     ...
     */
    lonlat2World(lonLat: Array<number>, length?: number, r?: number): Array<number>;
  ...
  class PanoManager {
     ...
     */
    static compute3DObjectProperties(panoPosition?: any, modelPosition?: any, modelAngles?: any): any;
     ...
     */
    static getProjectPanoData(projectID?: any, sCallback?: Function, eCallback?: Function): void;
  ...
  const Picker: PickerConstructor;

  interface PickerConstructor {
    new (): Picker;
  }
   ...
   */
  interface Plane extends THING.ThingGeometry {
    type: 'Plane';
    /** 判断是否 Plane 类型 */
    isPlane: boolean;
  }
  ...
  const PolygonLine: PolygonLineConstructor;

  interface PolygonLineConstructor {
    new (): PolygonLine;
  }
   ...
   */
  interface PolygonLine extends THING.PointsBase {
    type: 'PolygonLine';
    /** 设置进度, 范围在[0, 1]之间 */
    progress: number;
  }
   ...
   */
  interface Room extends THING.BaseObject {
    type: 'Room';
    /**
     * 获取该房间的面积，单位平方米
     * @example
     ...
     * ```
     */
    getAvaliablePositions(number: number, sizes: Array<Array<Number>>, holePoints?: Array<Array<Number>>): Array<Array<Number>>;
  }

  const RouteLine: RouteLineConstructor;

  interface RouteLineConstructor {
    new (): RouteLine;
  }
   ...
   */
  interface RouteLine extends THING.LineBase {
    type: 'RouteLine';
    /** 显示/隐藏 箭头 */
    arrowCap: boolean;
  ...
  class SceneLevel {
     ...
     */
    change(
      object: THING.BaseObject | CMAP.Map,
      params?: {
        /** (BETA) 完成回调函数 */
        complete: Function;
        [propName: string]: any;
  ...
  class Selector<T = BaseObject> {
     ...
     * @param callback 回调函数
     */
    filter<S extends T>(callbackfn: (value: S, index: number, array: S[]) => boolean): THING.Selector;
     ...
     * ```
     */
    forEach<S extends T>(callbackfn: (value: S, index: number, array: S[]) => void): void;
     ...
     * ```
     */
    off<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, condition: EventCondition | null | undefined, callback: Function | string): void;
     ...
     * @override
     */
    on<K extends keyof EventTypeMapping, T = any>(eventType: K | EventTypeT, callback: EventCallBackType<K>): void;
    /**
     * 绑定事件
     * @param eventType 事件类型名称
     * @param condition 物体类型选择条件，用于筛选子物体
     ...
     * ```
     */
    on<K extends keyof EventTypeMapping, T = any>(eventType: K | EventTypeT, condition?: EventCondition, userData?: T, callback?: EventCallBackType<K>, tag?: EventTagType): void;
     ...
     * @example
     */
    one<K extends keyof EventTypeMapping, T = any>(eventType: K | EventTypeT, condition?: EventCondition, userData?: T, callback?: EventCallBackType<K>, tag?: EventTagType): void;
     ...
     * @param tag 事件标签
     */
    pauseEvent<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, condition: EventCondition, tag?: EventTagType): void;
     ...
     * @param tag 事件标签
     */
    pauseEventInFrame<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, condition: EventCondition, tag?: EventTagType): void;
     ...
     * ```
     */
    resumeEvent<K extends keyof EventTypeMapping>(eventType: K | EventTypeT, condition?: EventCondition | null | undefined, tag?: EventTagType): void;
   ...
   * ```
   */
  interface Thing extends THING.BaseObject {
    type: 'Thing' | string;
    /**
  ...
  const UIAnchor: UIAnchorConstructor;

  interface UIAnchorConstructor {
    new (): UIAnchor;
  }
  ...
  class Utils {
    ...
    /**
     * 解析坐标信息
     * @param position 世界坐标信息
     */
    static parseVector3(position: number[]): {
      /** 判断当前位置与另一个位置的距离 */
      distanceTo: (currentPos: number[]) => number;
    };
    ...
    /** 验证是否是一个数组方法 */
    static isArray<T>(obj: T, shallow?: boolean): T;
     ...
     * ```
     */
    static dynamicLoad(urls: string | Array<string>, callback: Function, timestamp: boolean, inOrder: boolean): any;
    ...
    /**
     * 解析成渲染所需要的颜色值[0-1,0-1,0-1]
     * @param value 要解析的颜色字符
     * @example
     * ```
     * // 返回 {r: 1, g: 0, b: 0, isColor: true}
     * THING.Utils.parseColor('red')
     *
     * // 返回 {r: 0, g: 1, b: 0, isColor: true}
     * THING.Utils.parseColor('rgb(0, 255, 0)')
     * ```
     */
     ...
     * ```
     */
    static objectKeysToLowerCase(input: any, deep?: any, filter?: Function): any;
   ...
   * ```
   */
  interface Water extends THING.PointsBase {
    type: 'Water';
  }
   ...
   * ```
   */
  interface WebView extends THING.BaseObject {
    type: 'WebView';
    /**
     * 设置/获取 页面是否可被拾取（交互操作）
     *
